...
$tokenizer = new Text_Parser_CSS_Tokenizer(file_get_contents(dirname(__FILE__) . '/input/doubleselector.css'), new Text_Tokenizer_Regex_Matcher_Ext());
