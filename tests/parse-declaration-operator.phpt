--TEST--
Parse parse-declaration-operator.css
--FILE--
<?php
...
$tokenizer = new Text_Parser_CSS_Tokenizer(file_get_contents(dirname(__FILE__) . '/input/declaration-operator.css'), new Text_Tokenizer_Regex_Matcher_Ext());
